...
class FeatureExtractor(BaseEstimator, TransformerMixin):
    ...
    def extract_features(self,url):
        ...
        #features.append(len(re.findall(r'[0-9]', url)))  # Number of digits
        ...
        #features.append(len(re.findall(r'[^a-zA-Z0-9]', url)))  # Number of special characters
        #features.append(len(url.split('//')[-1].split('/')[0]))  # Length of hostname
        #features.append(1 if re.search(r'(login|signup|secure|account|update|free|verify|password)', url) else 0)  # Presence of keywords
        return features
